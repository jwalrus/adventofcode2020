...
class Day01Spec : DescribeSpec ({
    ...
    describe("part 1") {
        ...
        it("sample data = 514,579") {
            Day01Monad.run { sample.part1(2020) } shouldBeExactly 514_579
        }

        it("challenge data = 928,896") {
            Day01Monad.run { challenge.part1(2020) } shouldBeExactly 928_896
        }
    }
    ...
    describe("part 2") {
        ...
        it("sample data = 241,861,950") {
            Day01Monad.run { sample.part2(2020) } shouldBeExactly 241_861_950
        }

        it("challenge data = 295,668,576") {
            Day01Monad.run { challenge.part2(2020) } shouldBeExactly 295_668_576
        }
    }
